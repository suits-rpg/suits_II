// Generated on 2016-05-06 using generator-angular-fullstack 3.6.1
'use strict';
...
gulp.task('update.mongo.conf', function () {
  console.log('__dirname: ', __dirname);
  gulp.src('mongoData/mongoConfig.config')
    .pipe(replace(/".*mongoData/g, '"' + __dirname + '/mongoData'))
    .pipe(gulp.dest('mongoData/'));
});

gulp.task('mongo', ['update.mongo.conf'], shell.task(['mongod --config mongoData/mongoConfig.config']));
